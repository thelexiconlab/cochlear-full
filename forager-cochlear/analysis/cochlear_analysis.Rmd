...
#Summing nLL
agg_model_sum_nLL <- agg_model_results_clean %>% group_by(fullname,foraging_type,method,param1,param2,param3,Group,struct,dimension) %>%
...
```{r}
#overall best model
agg_model_sum_nLL_all <- agg_model_results_clean %>% group_by(fullname,foraging_type,method,param1,param2,param3,struct,dimension) %>%
  summarise(sum_nLL = sum(Negative_Log_Likelihood_Optimized)) %>%
  arrange(sum_nLL)
...
emmeans(best_switch_numb_lm,pairwise~domain,simple="domain")
...
nh_best_model = agg_model_results_clean %>% filter(Group=="normal hearing") %>%  mutate(full_model=paste(fullname,struct,dimension,sep="_"))%>%filter(full_model==best_model_nh) 

ci_best_model = agg_model_results_clean %>% filter(Group=="cochlear implant") %>% mutate(full_model=paste(fullname,struct,dimension,sep="_"))%>% filter(full_model==best_model_ci) 
...
agg_model_sum_nLL_dom <- agg_model_results_clean %>% group_by(fullname,foraging_type,method,param1,param2,param3,Group,domain,struct,dimension) %>%
  summarise(sum_nLL = sum(Negative_Log_Likelihood_Optimized)) %>%
  arrange(sum_nLL)
...
nh_a_best_model = agg_model_results_clean %>% mutate(full_model=paste(fullname,struct,dimension,sep="_")) %>% filter(Group=="normal hearing")%>% filter(domain=="animals") %>% filter(full_model==best_model_nh_a) 

nh_f_best_model = agg_model_results_clean %>% mutate(full_model=paste(fullname,struct,dimension,sep="_")) %>%filter(Group=="normal hearing")%>% filter(domain=="foods") %>%filter(full_model==best_model_nh_f) 

ci_a_best_model = agg_model_results_clean %>% mutate(full_model=paste(fullname,struct,dimension,sep="_")) %>%filter(Group=="cochlear implant")%>% filter(domain=="animals") %>% filter(full_model==best_model_ci_a)

ci_f_best_model = agg_model_results_clean %>% mutate(full_model=paste(fullname,struct,dimension,sep="_")) %>%filter(Group=="cochlear implant")%>% filter(domain=="foods") %>% filter(full_model==best_model_ci_f) 
...
emmeans(grp_best_beta_semantic_model,pairwise~Group*domain, simple="domain")
