...
# Note the demographics information is not publicly available due to confidentiality concerns.

#import data
#library(tableone)
#demos<-read.csv("../data/demographics.csv")

#demos_clean<-demos %>% select(ID,Group,Gender,NIH_Race,CAYRS2,Eti,FitMOS,UseYRS2) %>%filter(!(ID %in% c("754", "159")))%>%
#  rename(
#  Race = NIH_Race,
#  Age = CAYRS2,
#  Etiology = Eti)
