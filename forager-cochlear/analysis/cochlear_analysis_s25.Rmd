...
#comparing multimodal alphas in foods
group_mm_test=best_blended_delta_bic_analysis %>%
  filter(domain == "foods")
group_mm_table <- table(group_mm_test$Group, group_mm_test$param1)

# Number with mm alpha < 0.5
nh_foods_switch_alpha <- 14    
ci_foods_switch_alpha <- 5  


# Run 2 proportion z test
prop.test(x = c(nh_foods_switch_alpha,ci_foods_switch_alpha), n = c(nh_foods_total, ci_foods_total), correct = FALSE)
